...
Our choice to use California instead of any country was because of the data we had access to. Since we would like to asses the population density differences in subregions of a nation, we need access to more granular data than what the WHO COVID dataset has to offer.
