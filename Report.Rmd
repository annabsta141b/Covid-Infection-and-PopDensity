...
With that in mind, this study looks to answer one main research question:
...
To fully address this problem, our model will adjust for other regional socioeconomic factors, such as the percentage of the elderly and household income, to be sure that population density is the item being studied. This study focuses on California, and the key regions of Spain and Iraq due to their similarity to California (more information pertaining to this decision will be communicated in the remainder of the report). 
